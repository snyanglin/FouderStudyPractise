 ...
 * @Description:  [Drools规则实现类]   
 * @Author:       [yang.lin@founder.com.cn]  
 * @CreateDate:   [2016年1月13日 上午9:42:04]   
 * @UpdateUser:   [Administrator(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateDate:   [2016年1月13日 上午9:42:04，(如多次修改保留历史记录，增加修改记录)]   
 * @UpdateRemark: [说明本次修改内容,(如多次修改保留历史记录，增加修改记录)]  
 * @Version:      [v1.0]
 */
public class PointRuleEngineImpl implements PointRuleEngine {
	private RuleBase ruleBase;//这是个接口，使用需要实例化类初始它
	...
	public void executeRuleEngine(final PointDomain pointDomain) {
		...
		statefulSession.insert(pointDomain);  //插入参数
